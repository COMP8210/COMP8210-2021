...
Each task will be assessed according to the following rubric.

| Type | 1 Mark | 2 Marks | 3 Marks | 4 Marks | 5 Marks |
| --- | --- | --- | --- | --- | --- |
| Task 1 | There are significant problems. | There was a visualisation but there are still significant problems. | Largely correct code with only minor errors. Largely correct visualisation but there is no coherent explanation. | Correct code and visualisation. A reasonable interpretation but either the visualisation or the explanation can be improved. | As previous column, plus excellent visualisation and insightful interpretation. The explanation justifies the choice of techniques used, and it shows that the chosen techniques are the most appropriate. Could be used as part of a business report. |
| Task 2 | There are significant problems. | There was a visualisation of the clusters but there are still significant problems, for example it is difficult to distinguish the clusters. | Largely correct code and visualisation but incoherent or no explanation. The text does not explain what clustering method was used, what method was used to render them, or what criteria was used to determine the number of clusters. | Correct code. A reasonable interpretation but either the visualisation or the explanation can be improved. | As previous column, plus excellent visualisation and insightful interpretation. The explanation justifies the choice of techniques used, and it shows that the chosen techniques are the most appropriate. Could be used as part of a business report. |
| Task 3 | There are significant problems. | There was a word cloud visualisation for some or all clusters but there are still significant problems, for example it is difficult to identify the representative words. | Largely correct code and visualisation. All word clouds are visualised. However, there was incoherent or no explanation. Unclear what criteria was used to determine the most representative words. | Correct code. A reasonable interpretation but either the visualisation or the explanation can be improved. | As previous column, plus excellent visualisation and insightful interpretation. The explanation justifies the choice of techniques used, and it shows that the chosen techniques are the most appropriate. Could be used as part of a business report. |
| Task 4 | There are significant problems. | Topic modelling was conducted and there was a visualisation of the topics but there are still significant problems, for example it is difficult to determine the most common topics. | Largely correct code and visualisation. However, there was incoherent or no explanation. Unclear what criteria was used to determine the most common topics. | Correct code. A reasonable interpretation but either the visualisation or the explanation can be improved. | As previous column, plus excellent visualisation and insightful interpretation. The explanation justifies the choice of techniques used, and it shows that the chosen techniques are the most appropriate. Could be used as part of a business report. |
| Task 5 | There are significant problems. | Topic modelling was conducted and there was a visualisation of the topics but there are still significant problems, for example there was an separate topic modelling of each cluster, or the visualisation is confusing. | Largely correct code and visualisation. However, there was incoherent or no explanation. Unclear what methods were used. | Correct code. A reasonable interpretation but either the visualisation or the explanation can be improved. | As previous column, plus excellent visualisation and insightful interpretation. The explanation justifies the choice of techniques used, and it shows that the chosen techniques are the most appropriate. Could be used as part of a business report. |
